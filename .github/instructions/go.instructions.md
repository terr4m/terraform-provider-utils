...
- Always use `gofumpt` to format code
...
- Log messages should be sentances.
- Use slog and structured attributes for logging.
...
- Place all test helpers in `helpers_test.go`
